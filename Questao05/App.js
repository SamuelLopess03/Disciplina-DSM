...
import Btn from './src/components/Botao';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.botoes}>
        <Btn label="AC" triplo ac aoClicar={() => {opera("AC")}}></Btn>
        ...
        <Btn label="+" operacao aoClicar={() => {addDigito('+')}}></Btn>
        <Btn label="0" duplo aoClicar={() => {addDigito('0')}}></Btn>
        <Btn label="." aoClicar={() => {addDigito('.')}}></Btn>
        <Btn label="=" operacao aoClicar={() => {opera("=")}}></Btn>
      </View>
    </View>
  );
}
